#line 1 "C:\\Users\\SShahryiar\\Desktop\\N76E003 Tutorial\\N76E003 IAR Code Examples\\Codes\\PWM (Complimentary with Dead Time)\\main.c"
...
#line 2 "C:\\Users\\SShahryiar\\Desktop\\N76E003 Tutorial\\N76E003 IAR Code Examples\\Codes\\PWM (Complimentary with Dead Time)\\main.c"
...
#line 3 "C:\\Users\\SShahryiar\\Desktop\\N76E003 Tutorial\\N76E003 IAR Code Examples\\Codes\\PWM (Complimentary with Dead Time)\\main.c"
...
#line 4 "C:\\Users\\SShahryiar\\Desktop\\N76E003 Tutorial\\N76E003 IAR Code Examples\\Codes\\PWM (Complimentary with Dead Time)\\main.c"
...
#line 5 "C:\\Users\\SShahryiar\\Desktop\\N76E003 Tutorial\\N76E003 IAR Code Examples\\Codes\\PWM (Complimentary with Dead Time)\\main.c"
...
#line 6 "C:\\Users\\SShahryiar\\Desktop\\N76E003 Tutorial\\N76E003 IAR Code Examples\\Codes\\PWM (Complimentary with Dead Time)\\main.c"
...
void main(void)
{
  ...
  PWMCON1|=0x40;PWMCON1&=0x7F;
  PWMCON1|=0x10;
  PWMCON0_bit . BIT4 = 1;
  CKCON&=0xBF;
  PWMCON1|=0x06;PWMCON1&=0xFE;
  PNP|=0x01;
  PNP|=0x02;
  set_PWM_period(600);
  set_PWM_dead_time(40);
  BIT_TMP=IE_bit . BIT7;IE_bit . BIT7=0;TA=0xAA;TA=0x55;PDTEN|=0x01;IE_bit . BIT7=BIT_TMP;
  PWMCON0_bit . BIT7 = 1;
...
void set_PWM4(unsigned int value)
{
  BIT_TMP=IE_bit . BIT7;IE_bit . BIT7=0;TA=0xAA;TA=0x55;SFRS|=0x01;IE_bit . BIT7=BIT_TMP;
  PWM4L = (value & 0x00FF);

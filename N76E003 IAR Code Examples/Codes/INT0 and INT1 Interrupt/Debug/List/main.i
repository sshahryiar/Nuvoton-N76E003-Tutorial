...
void setup(void)
{
  ...
  P1M1|=0x80;P1M2&=~0x80;
  P3M1|=0x01;P3M2&=~0x01;	
  BIT_TMP=IE_bit . BIT7;TA=0xAA;TA=0x55;SFRS=0x01;P1S|=0x80;TA=0xAA;TA=0x55;SFRS=0x00;IE_bit . BIT7=BIT_TMP;
  BIT_TMP=IE_bit . BIT7;TA=0xAA;TA=0x55;SFRS=0x01;P3S|=0x01;TA=0xAA;TA=0x55;SFRS=0x00;IE_bit . BIT7=BIT_TMP;
  TCON_bit . BIT0 = 1;
  TCON_bit . BIT2 = 1;
  IE_bit . BIT0 = 1;
  IE_bit . BIT2 = 1;
